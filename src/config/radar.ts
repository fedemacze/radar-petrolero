...
export const PREFILTER = {
  ...
  projectSignals: [
    "plan de inversión aprobado", "inversión confirmada", "reactivación de pozos", "puesta en marcha de planta", "ampliación de planta",
    "inicio de obra", "obra adjudicada", "construcción de ducto", "construcción de planta", "inicio de operaciones", "reinicio de operaciones",
  ...
  serviceSignals: [
    ...
    "protección catódica", "reparación de ductos", "reemplazo de ductos", "reparación de instalaciones",
    "recuperación secundaria", "recuperación terciaria", "inyección", "pozo productor", "pozo inyector",
    "gestión de almacén", "operación de depósito", "pañol", "gestión de inventario", "gestión de stock", "repuestos", "logística petrolera",
    "transporte de cargas", "cargas líquidas", "cargas sólidas", "transporte de crudo", "agua de producción", "transporte de residuos",
  ...
  displacementSignals: [
    "incumplimiento del contratista", "incumplimiento del proveedor", "rescindió el contrato", "rescisión del contrato",
    "sancionó a la contratista", "sanción a la contratista", "fallas del contratista", "fallas del proveedor",
    "reemplazo del contratista", "cambio de contratista", "cambio de proveedor", "servicio interrumpido por la contratista",
    "paro de la contratista", "paro de trabajadores de la contratista", "abandono del servicio",
  ],
  exclusionSignals: [
